...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '1769132732 1861354020').split()]
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1001985098865').split()]
auth_users = [int(user) if id_pattern.search(user) else user for user in environ.get('AUTH_USERS', '').split()]
AUTH_USERS = (auth_users + ADMINS) if auth_users else []
auth_channel = environ.get('AUTH_CHANNEL', '-1001981760264')
...
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/+K6DIefAu3SpmMDll')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/f7moviesofficial')
MSG_ALRT = environ.get('MSG_ALRT', 'Wʜᴀᴛ Aʀᴇ Yᴏᴜ Lᴏᴏᴋɪɴɢ Aᴛ ?')
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', -1002017146119))
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/+K6DIefAu3SpmMDll')
